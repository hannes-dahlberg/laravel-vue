            ...
            <div class="col-12 mt-4">
                <div class="row">
                    <div class="col-6">
                        ...
                        <h3 class="mt-3">
                            Log
                            <a class="btn btn-sm btn-secondary" href="#" v-on:click.prevent="clear('public')">Clear</a>
                        </h3>
                    ...
                    <div class="col-6">
                        ...
                        <div v-if="isAuth">
                            ...
                            <h3 class="mt-3">
                                Log
                                <a class="btn btn-sm btn-secondary" href="#" v-on:click.prevent="clear('private')">Clear</a>
                            </h3>
                            <table class="table table-striped table-bordered">
                                <tbody>
